...
var oidSSW = []OIDAttr{
	...
	OIDAttr{Name: "kssw_current_net_ip", OID: "1800.53.10.4", Type: gosnmp.OctetString, ReadOnly: true, ValidHander: defaultValidHander},
	OIDAttr{Name: "kssw_current_net_mac", OID: "1800.53.10.5", Type: gosnmp.OctetString, ReadOnly: true, ValidHander: defaultValidHander},
	OIDAttr{Name: "kssw_net0_link_status", OID: "1800.53.10.6", Type: gosnmp.Integer, ReadOnly: true, ValidHander: defaultValidHander},
	OIDAttr{Name: "kssw_net1_link_status", OID: "1800.53.10.7", Type: gosnmp.Integer, ReadOnly: true, ValidHander: defaultValidHander},
	...
	OIDAttr{Name: "kssw_master_dns", OID: "1800.53.11.5", Type: gosnmp.OctetString, ReadOnly: false, ValidHander: ksswMasterDns},
	OIDAttr{Name: "kssw_slave_dns", OID: "1800.53.11.6", Type: gosnmp.OctetString, ReadOnly: false, ValidHander: ksswSlaveDns},
}
